  ...
  const send = async contact => {
    try {
      const reponce = await axios.post(
        `https://techkilla-server.vercel.app/qr-solution`,
        { ...contact, utm_campaign, utm_medium, utm_source }
      );
        ...
        <div className="mainContainer">
          ...
          <div className="microSection2">
            <Container>
              ...
              <div className="micro_heading01 mb-5">
                    ...
                    {index == 2 || index == 3 ? (
                      <div className="d-flex align-items-start">
                        ...
                        <div className="microFun_contain px-3">
                          <h3 className="micro_titl">{item.title}</h3>
                          <p className="micro_des">{item.desc}</p>
                        </div>
                      </div>
                    ) : (
              ...
              <Container>
                <Row className="align-items-center">
                  {choose_list?.map((item, index) => {
                    return (
                      <Col xxl={6} lg={6} md={12} sm={12} xs={12} key={index}>
                        <Row>
                          <Col
                            xxl={8}
                            xl={8}
